...
import { TERMS_SECTIONS, INTRO_TEXT } from "@/lib/termsData";

export const metadata: Metadata = {
  title: "Terms of Service — Seftekra",
  description:
    "Seftekra Energy terms of service — governing your use of our platform and infrastructure development services.",
};
